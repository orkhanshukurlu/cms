                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6 col-md-9 col-sm-12">
                                    <div class="input-group">
                                        <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name', $role) }}" placeholder="Ad daxil edin">
                                        @error('name')
                                    ...
                                    <div class="input-group">
                                        <select class="form-control select-2 @if($errors->has('permissions') || $errors->has('permissions.*')) is-invalid @endif" name="permissions[]" multiple>
                                            ...
                                            @foreach ($permissions as $item)
                                                <option value="{{ $item->id }}" @selected(collect(old('permissions', $role->permissions->modelKeys()))->contains($item->id))>
