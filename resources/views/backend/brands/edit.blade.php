                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6 col-md-9 col-sm-12">
                                    <div class="input-group">
                                        <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name', $brand) }}" placeholder="Ad daxil edin">
                                        @error('name')
                                ...
                                <div class="col-lg-6 col-md-9 col-sm-12">
                                    <div class="input-group">
                                        <select class="form-control select-2 @error('status') is-invalid @enderror" name="status">
                                            <option value=""></option>
                                            <option value="1" @selected(old('status', $brand) == 1)>Aktiv</option>
                                            <option value="0" @selected(old('status', $brand) == 0 && is_numeric(old('status', $brand)))>Deaktiv</option>
                                        </select>
                                        @error('status')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                        ...
                        <div class="card-footer">
                            <div class="row">
                                <div class="col-lg-9 ml-lg-auto">
                                    ...
                                    <a href="{{ route('backend.brands.index') }}" class="btn btn-light-primary">Geri qayıt</a>
                                </div>
                            </div>
                        </div>
                    </form>
