                ...
                <div class="card card-custom example example-compact">
                    ...
                    <form action="{{ route('backend.settings.store') }}" method="POST">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6 col-md-9 col-sm-12">
                                    <div class="input-group">
                                        <input type="text" class="form-control @error('keyword') is-invalid @enderror" name="keyword" value="{{ old('keyword') }}" placeholder="Açar söz daxil edin">
                                        @error('keyword')
                            ...
                            <div class="form-group row">
                                <label class="col-form-label text-right col-lg-3 col-sm-12">
                                    Məzmun <span class="text-danger">*</span>
                                </label>
                                <div class="col-lg-6 col-md-9 col-sm-12">
                                    <div class="input-group">
